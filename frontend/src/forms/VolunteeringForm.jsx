      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., Beach Cleanup Drive</p>
            <input
              type="text"
              name="activity_name"
              required
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., NSS, Rotary Club</p>
            <input
              type="text"
              name="organization"
              required
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., Volunteer, Team Lead</p>
            <input
              type="text"
              name="role"
              required
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., Environment, Education</p>
            <input
              type="text"
              name="cause"
              required
          ...
          <div>
            ...
            <div className="flex items-center mb-2">
              ...
              />
              <label htmlFor="ongoing" className="ml-2 text-xs font-medium text-red-500">
                Ongoing activity
              </label>
            </div>
            <input
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 flex items-center gap-2">
              Hours Contributed (Optional)
            </label>
            <p className="text-xs text-gray-400 mb-1">Total volunteer hours</p>
            <input
              type="number"
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-gray-400 mb-1">Briefly describe your responsibilities and impact</p>
            <textarea
              name="description"
              required
