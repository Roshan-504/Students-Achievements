...
const NonTechnicalActivityForm = ({ initialData, onSubmit }) => {
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., Cultural Fest</p>
            <input
              type="text"
              name="activity_name"
              required
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., Sports Tournament</p>
            <input
              type="text"
              name="type"
              required
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">e.g., University of Arts</p>
            <input
              type="text"
              name="institute"
              required
          ...
          {/* Organizer */}
          <div>
            <label className="block text-sm font-medium text-gray-700">Organizer (Optional)</label>
            <p className="text-xs text-gray-400 mb-1">e.g., Student Union, Cultural Club</p>
            <input
              type="text"
              name="organizer"
        ...
        <div className="w-full mt-6 flex justify-center">
          <button
            ...
            disabled={!formData.proof && !formData.no_certificate_yet}
...
export default NonTechnicalActivityForm;