...
const StudentProfile = () => {
  ...
  const fields = [
    ...
    { key: 'first_name', label: 'First Name', icon: User, editable: true },
    { key: 'middle_name', label: 'Middle Name', icon: User, editable: true },
    { key: 'last_name', label: 'Last Name', icon: User, editable: true },
    { key: 'mother_name', label: 'Mother\'s Name', icon: User, editable: true },
    { key: 'department', label: 'Department', icon: Book, editable: true },
    { key: 'batch_no', label: 'Batch Number', icon: Calendar, editable: true },
    { key: 'division', label: 'Division', icon: Book, editable: true },
